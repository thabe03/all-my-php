...
// $c = (array)$dg->data->results;
// $b = array_map(function($val) { return $val->name; }, $c);
...
<?php } ?>
  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Recherche de <a href='https://www.marvel.com/' class="text-light text-decoration-none">super Héro</a></h5>
  <div class="autocomplete form-outline mb-4" style="width:300px;">
    <input type="text" class="form-control form-control-lg" placeholder="super Héro" name="e" autocomplete="off" id="myInput" value="<?php echo isset($_POST['e']) ? $e : ""; ?>"/>
